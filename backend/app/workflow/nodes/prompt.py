...
SYSTEM_PROMPT = (
    "You are an expert AI image/video prompt engineer specializing in product "
    "photography and cinematography. Always respond with valid JSON only."
)


class PromptHandler(BaseNodeHandler):
    node_type = "prompt"
    node_label = "Prompt Generation"
